namespace Nihdi.DevoLearning.Presentation.Features.Persons.Overview.ServiceClients
{
    ...
    public class PersonOverviewServiceClient : IPersonOverviewServiceClient
    {
        ...
        public Task<PaginatedResult<PersonOverviewModel>> GetPersonsAsync(PersonOverviewQuery query)
        {
            ...
            return Task.FromResult(new PaginatedResult<PersonOverviewModel>
            {
                Items = pagedItems,
